export const db = {
  project: [
    ...
    },
    {
      ...
      link: "https://compassion-clone.web.app",
      github: "https://github.com/jbinyim/compassion-clone",
      imgUrl: [
        "https://jbinyim12.cafe24.com/web/upload/captcha/image%208.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/home.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/story.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/children.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/special.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/event.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/news.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/spon.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/login.png",
    ...
    },
    {
      ...
      imgUrl: [
        "https://img.freepik.com/free-photo/toy-bricks-table-with-word-my-blog_144627-47466.jpg?size=626&ext=jpg&ga=GA1.1.2008272138.1723248000&semt=ais_hybrid",
        "https://jbinyim12.cafe24.com/web/upload/captcha/hometail.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/seemoretail.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/add.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/edit.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/logintail.png",
        "https://jbinyim12.cafe24.com/web/upload/captcha/registertail.png",
      ],
      text: "",
    },
    {
      ...
      type: "react",
      name: "넷플릭스",
      ing: "현재 저작권 문제로 배포 사이트가 닫혀있는 상태입니다.",
      catagory: "개인",
      skill: ["react", "typescript", "react-query"],
    ...
    },
    {
      ...
      func: [
        ...
        "로컬 스토리지를 이용하여 다이어리 항목을 생성(Create), 조회(Read), 수정(Update), 삭제(Delete)할 수 있습니다.",
      ],
    ...
    },
    {
      ...
      imgUrl: [
        "https://yimjbin-26a95.web.app/img/logo/bLogo.png",
  ...
  example: [
    ...
    },
    {
      ...
      imgUrl: [
        ...
        "https://jbinyim12.cafe24.com/web/upload/captcha/coin.png",
      ],
    ...
    },
    {
      ...
      imgUrl: [
        ...
        "https://jbinyim12.cafe24.com/web/upload/captcha/books.png",
      ],
    ...
    },
    {
      ...
      imgUrl: [
        ...
        "https://jbinyim12.cafe24.com/web/upload/captcha/memo.png",
      ],
...
export const skillLogo = {
  common: [
    ...
    },
    {
      ...
      desc: "구조에 따라 어울리는 레이아웃으로 flex, grid 등을 사용하여 배치하고 적용합니다.",
      colors: "#2965F1",
    },
    {
      name: "JavaScript",
  ...
  frontend: [
    ...
    },
    {
      ...
      desc: "필요한 타입을 직접 만들어 적용할 수 있고, 유틸리티 타입들도 활용할 수 있습니다.",
      colors: "#007ACC",
    },
    {
      name: "React-Query",
      img: "https://jbinyim12.cafe24.com/web/upload/captcha/react-query-logo.png",
      desc: "서버의 요청할 CRUD에 대한 훅을 만들 수 있고, 서버의 데이터를 관리하기 위해 사용할 수 있습니다.",
      colors: "#FF4154",
    },
    {
      name: "Redux",
    ...
    },
    {
      ...
      desc: "상태관리를 위해 사용할 수 있습니다.",
      colors: "#00BFFF",
    },
    {
      name: "Scss",
      img: "https://jbinyim12.cafe24.com/web/upload/captcha/sass-original.png",
      desc: "Nesting을 통해 반복되는 선택자 사용을 줄일수 있고, 변수를 사용해서 속성값을 통일해서 관리할 수 있습니다.",
      colors: "#C6538C",
    },
    {
  ...
  tool: [
    {
      ...
      desc: "Git을 이용해서 관리하는 코드를 공유 및 저장하기 위해 사용합니다.",
      colors: "#181717",
    },
    {
      name: "Firebase",
      img: "https://jbinyim12.cafe24.com/web/upload/captcha/firebase-plain.png",
      desc: "개인 프로젝트를 배포할 때 사용해본 경험이 있습니다.",
      colors: "#FFCA28",
    },
    {
      name: "Figma",
    ...
    {
      name: "Slack",
      img: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Slack_icon_2019.svg/1024px-Slack_icon_2019.svg.png",
      desc: "팀원들과 주로 연락하는 메신저입니다.",
      colors: "#4A154B",
    },
    {
      name: "VSCode",
      img: "https://jbinyim12.cafe24.com/web/upload/captcha/Visual_Studio_Code_icon.png",
      desc: "주로 사용하는 에디터입니다.",
      colors: "#007ACC",
    },
  ],
  etc: [
    ...
    {
      name: "Photoshop",
      img: "https://jbinyim12.cafe24.com/web/upload/captcha/photoshop-logo.png",
      desc: "기본적인 기능들만 사용할 수 있습니다.",
      colors: "#31A8FF",
    },
  ],
};
